 ...
 * @property {string} Msg API 调用返回消息
 * @property {Array<any>} Data Data
 */\nexport async function prependDailyNoteBlock(params) {\n  // Example: return fetchWrapper('POST', '/api/block/prependDailyNoteBlock', params, true);\n  console.log('Mock call to prependDailyNoteBlock with:', params);\n  return Promise.resolve({}); // TODO: Ensure mock response matches Promise<PrependDailyNoteBlockResponse>\n}\n\n/**\n * 将指定的块移动到新的父块下或同级块的特定位置。移动后会触发相关文档编辑器的重载。\n * (Requires authentication, Requires admin role, Unavailable in read-only mode)\n * @param {object} params - Request parameters.\n * @returns {Promise<object>}\n * @param {string} params.id 要移动的块的 ID。
 ...
 */\nexport async function moveBlock(params) {\n  // Example: return fetchWrapper('POST', '/api/block/moveBlock', params, true);\n  console.log('Mock call to moveBlock with:', params);\n  return Promise.resolve({}); // TODO: Ensure mock response matches Promise<MoveBlockResponse>\n}\n\n/**\n * 移动大纲中的标题块到新的父级或同级位置。\n * (Requires authentication, Requires admin role, Unavailable in read-only mode)\n * @param {object} params - Request parameters.\n * @returns {Promise<object>}\n * @param {string} params.id 要移动的大纲标题块的 ID。
 * @param {string} [params.parentID] parentID
 * @param {string} [params.previousID] previousID
 * @property {number} Code API 调用返回码，0 表示成功
 * @property {string} Msg API 调用返回消息
 * @property {Array<any>} Data Data
 */\nexport async function moveOutlineHeading(params) {\n  // Example: return fetchWrapper('POST', '/api/block/moveOutlineHeading', params, true);\n  console.log('Mock call to moveOutlineHeading with:', params);\n  return Promise.resolve({}); // TODO: Ensure mock response matches Promise<MoveOutlineHeadingResponse>\n}\n\n